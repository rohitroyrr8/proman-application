...
public class PasswordCryptographyProvider {
     ...
     */
    public String[] encrypt(final String password) throws InvalidKeySpecException {
     ...
     */
    public String encrypt(final String password, String salt) throws InvalidKeySpecException {
     ...
     * @return byte array of hashed password.
     */
    private static byte[] hashPassword(final char[] password, final byte[] salt) throws InvalidKeySpecException {
        try {
